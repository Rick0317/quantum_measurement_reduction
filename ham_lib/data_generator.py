...
from openfermionpyscf import generate_molecular_hamiltonian, run_pyscf


def generate_molecule_data(
    geometry, file_name, basis="sto3g", multiplicity=1, charge=0
):

    # Get FermionOperator for the molecular Hamiltonian
    fermion_hamiltonian = generate_molecular_hamiltonian(
