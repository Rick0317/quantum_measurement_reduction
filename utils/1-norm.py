        ...
        for j in range(n):
            for k in range(n):
                for l in range(n):
                    one_norm += abs(
                        0.5 * g2e[i, j, k, l]
                        + 1.5 * sum(t3e[i, j, k, l, m, m] for m in range(n))
                    )
            ...
            for k in range(i):
                for l in range(j):
                    one_norm += abs(
                        ...
                        + 3
                        * sum(
                            t3e[i, j, k, l, m, m] - t3e[i, l, k, j, m, m]
                            for m in range(n)
                        )
                    )
...
if __name__ == "__main__":
    ...
    estimated_1norm = (
        ...
        + two_body_1norm_est5
        + two_body_1norm_est6
        + three_body_1norm_est1
        + three_body_1norm_est2
    )
    fermion_operator = FermionOperator()
    fermion_operator = construct_one_body_fermion_operator(fermion_operator, h1e)
    fermion_operator = construct_two_body_fermion_operator(fermion_operator, g2e)
    fermion_operator = construct_three_body_fermion_operator(fermion_operator, t3e)
    ...
    print(
        f"4 Majo Norm (1) Estimated: {two_body_1norm_est1 }, Correct: {four_majo_norm1}"
    )
    print(
        f"4 Majo Norm (2) Estimated: {two_body_1norm_est2}, Correct: {four_majo_norm2}"
    )
    print(
        f"4 Majo Norm Estimated: {two_body_1norm_est1 + two_body_1norm_est2}, Correct: {four_majo_norm1 + four_majo_norm2}"
    )
