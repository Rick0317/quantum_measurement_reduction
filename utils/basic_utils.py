    ...
    for p in range(num_orbitals):
        for q in range(num_orbitals):
            ...
            if coefficient != 0.0:
                ...
                term_alpha_alpha = FermionOperator(
                    ((2 * p, 1), (2 * q, 0)), coefficient
                )
                ferm_op += term_alpha_alpha

                # Beta-beta: (2*p+1, 1) and (2*q+1, 0)
                term_beta_beta = FermionOperator(
                    ((2 * p + 1, 1), (2 * q + 1, 0)), coefficient
                )
                ...
                for s in range(num_orbitals):
                    ...
                    if coefficient != 0.0:
                        term_1 = FermionOperator(
                            ((2 * p, 1), (2 * q, 0), (2 * r, 1), (2 * s, 0)),
                            coefficient,
                        )
                        term_2 = FermionOperator(
                            ((2 * p + 1, 1), (2 * q + 1, 0), (2 * r, 1), (2 * s, 0)),
                            coefficient,
                        )
                        term_3 = FermionOperator(
                            ((2 * p, 1), (2 * q, 0), (2 * r + 1, 1), (2 * s + 1, 0)),
                            coefficient,
                        )
